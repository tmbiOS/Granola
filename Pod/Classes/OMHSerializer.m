...
+ (HKHealthStore *)healthStore {
 static NSDictionary *healthStore = nil;
 if (healthStore == nil) {
...
/**
This serializer maps data from HKQuantityTypeIdentifierHeartRateVariabilitySDNN samples to JSON
*/
@interface OMHSerializerHeartRateVariabilitySDNN : OMHSerializer; @end;
@implementation OMHSerializerHeartRateVariabilitySDNN
+ (BOOL)canSerialize:(HKQuantitySample*)sample error:(NSError**)error {
   return YES;
}
- (id)bodyData {
...
/**
This serializer maps data from HKDataTypeIdentifierElectrocardiogram samples to JSON
*/
@interface OMHSerializerHeartElectrocardiogram : OMHSerializer; @end;
@implementation OMHSerializerHeartElectrocardiogram
